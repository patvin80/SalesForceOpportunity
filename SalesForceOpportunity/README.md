...
This is a sample template for SalesForceOpportunity - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name salesforceopportunity \
...
aws cloudformation describe-stacks \
    --stack-name salesforceopportunity --query 'Stacks[].Outputs'
```
